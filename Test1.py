...
The Key Metric being discussed is {ta_metric_1_choice} female percent where the actual percent is {percentage} which is below what the hiring manager wants.
